...
export default function PatientSettings({ userId }: { userId: string }) {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      if (settings.reduce_motion) {
        document.documentElement.style.setProperty("--tw-motion-reduce", "reduce")
      }
      ...
      <div className="border-b border-border bg-card">
        <div className="max-w-4xl mx-auto px-4 py-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Accessibility & Preferences</p>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Features to improve usability</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="screenReaderMode">Screen Reader Mode</Label>
                <p className="text-sm text-muted-foreground">Optimize for screen reader compatibility</p>
              </div>
              <Switch
                id="screenReaderMode"
                checked={settings.screen_reader_mode}
                onCheckedChange={(checked) => setSettings({ ...settings, screen_reader_mode: checked })}
              />
            </div>
          </CardContent>
        </Card>
