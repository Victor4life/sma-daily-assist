...
export default function PatientHeader({ userId }: { userId: string }) {
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="font-semibold">{profile?.full_name || "Patient"}</p>
            <p className="text-xs text-muted-foreground">Care Mode</p>
          </div>
